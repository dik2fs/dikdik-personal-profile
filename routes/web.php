...
Route::prefix('admin')->middleware(['auth'])->group(function () {
    ...
    Route::put('/projects/{project}/toggle-featured', [AdminProjectController::class, 'toggleFeatured'])->name('admin.projects.toggle-featured');
    ...
    Route::put('/books/{book}/toggle-featured', [AdminBookController::class, 'toggleFeatured'])->name('admin.books.toggle-featured');
    Route::put('/books/{book}/toggle-available', [AdminBookController::class, 'toggleAvailable'])->name('admin.books.toggle-available');
