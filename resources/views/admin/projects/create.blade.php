        ...
        <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="Contoh: Sistem Manajemen Inventori">
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <!-- Image Upload -->
                   <!-- Tambahkan di bagian image upload -->
<div>
    ...
    <p class="mt-1 text-sm text-gray-500">Format: JPG, PNG, GIF, WEBP. Maksimal: 2MB</p>
    ...
    @endif
            ...
            <div class="mt-6">
                ...
                <textarea id="description" 
                          ...
                          required
                          class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Jelaskan detail tentang proyek ini...">{{ old('description') }}</textarea>
            </div>
